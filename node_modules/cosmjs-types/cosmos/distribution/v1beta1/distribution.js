...
exports.ValidatorCurrentRewards = {
    ...
    fromJSON(object) {
        return {
            ...
            period: isSet(object.period) ? long_1.default.fromString(object.period) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.ValidatorSlashEvent = {
    ...
    fromJSON(object) {
        return {
            validatorPeriod: isSet(object.validatorPeriod) ? long_1.default.fromString(object.validatorPeriod) : long_1.default.UZERO,
...
exports.DelegatorStartingInfo = {
    ...
    fromJSON(object) {
        return {
            previousPeriod: isSet(object.previousPeriod) ? long_1.default.fromString(object.previousPeriod) : long_1.default.UZERO,
