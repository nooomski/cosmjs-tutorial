...
exports.QueryValidatorSlashesRequest = {
    ...
    fromJSON(object) {
        return {
            validatorAddress: isSet(object.validatorAddress) ? String(object.validatorAddress) : "",
            startingHeight: isSet(object.startingHeight) ? long_1.default.fromString(object.startingHeight) : long_1.default.UZERO,
            endingHeight: isSet(object.endingHeight) ? long_1.default.fromString(object.endingHeight) : long_1.default.UZERO,
...
exports.QueryCommunityPoolResponse = {
    ...
    fromJSON(object) {
        return {
            pool: Array.isArray(object === null || object === void 0 ? void 0 : object.pool) ? object.pool.map((e) => coin_1.DecCoin.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
