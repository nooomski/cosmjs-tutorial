    ...
    fromJSON(object) {
        return {
            ...
            delegatedVesting: Array.isArray(object === null || object === void 0 ? void 0 : object.delegatedVesting)
                ...
                : [],
            endTime: isSet(object.endTime) ? long_1.default.fromString(object.endTime) : long_1.default.ZERO,
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromJSON(object) {
        return {
            baseVestingAccount: isSet(object.baseVestingAccount)
                ...
                : undefined,
            startTime: isSet(object.startTime) ? long_1.default.fromString(object.startTime) : long_1.default.ZERO,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.Period = {
    ...
    fromJSON(object) {
        return {
            length: isSet(object.length) ? long_1.default.fromString(object.length) : long_1.default.ZERO,
