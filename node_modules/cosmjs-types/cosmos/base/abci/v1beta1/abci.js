...
exports.TxResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            gasWanted: isSet(object.gasWanted) ? long_1.default.fromString(object.gasWanted) : long_1.default.ZERO,
            gasUsed: isSet(object.gasUsed) ? long_1.default.fromString(object.gasUsed) : long_1.default.ZERO,
...
exports.GasInfo = {
    ...
    fromJSON(object) {
        return {
            gasWanted: isSet(object.gasWanted) ? long_1.default.fromString(object.gasWanted) : long_1.default.UZERO,
            gasUsed: isSet(object.gasUsed) ? long_1.default.fromString(object.gasUsed) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.SearchTxsResult = {
    ...
    fromJSON(object) {
        return {
            totalCount: isSet(object.totalCount) ? long_1.default.fromString(object.totalCount) : long_1.default.UZERO,
            count: isSet(object.count) ? long_1.default.fromString(object.count) : long_1.default.UZERO,
            pageNumber: isSet(object.pageNumber) ? long_1.default.fromString(object.pageNumber) : long_1.default.UZERO,
            pageTotal: isSet(object.pageTotal) ? long_1.default.fromString(object.pageTotal) : long_1.default.UZERO,
