...
exports.GetValidatorSetByHeightResponse = {
    ...
    fromJSON(object) {
        return {
            blockHeight: isSet(object.blockHeight) ? long_1.default.fromString(object.blockHeight) : long_1.default.ZERO,
...
function createBaseValidator() {
    return { address: "", pubKey: undefined, votingPower: long_1.default.ZERO, proposerPriority: long_1.default.ZERO };
}
exports.Validator = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.address !== "") {
    ...
    fromJSON(object) {
        return {
            ...
            votingPower: isSet(object.votingPower) ? long_1.default.fromString(object.votingPower) : long_1.default.ZERO,
            proposerPriority: isSet(object.proposerPriority) ? long_1.default.fromString(object.proposerPriority) : long_1.default.ZERO,
        };
    },
    toJSON(message) {
        const obj = {};
