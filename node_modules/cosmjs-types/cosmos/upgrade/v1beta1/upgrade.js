...
function createBasePlan() {
    return { name: "", time: undefined, height: long_1.default.ZERO, info: "", upgradedClientState: undefined };
}
exports.Plan = {
...
exports.ModuleVersion = {
    ...
    fromJSON(object) {
        return {
            name: isSet(object.name) ? String(object.name) : "",
            version: isSet(object.version) ? long_1.default.fromString(object.version) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
