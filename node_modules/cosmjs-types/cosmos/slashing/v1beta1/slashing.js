...
exports.ValidatorSigningInfo = {
    ...
    fromJSON(object) {
        return {
            ...
            startHeight: isSet(object.startHeight) ? long_1.default.fromString(object.startHeight) : long_1.default.ZERO,
            indexOffset: isSet(object.indexOffset) ? long_1.default.fromString(object.indexOffset) : long_1.default.ZERO,
