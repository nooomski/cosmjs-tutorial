...
exports.SignDoc = {
    ...
    fromJSON(object) {
        return {
            ...
            accountNumber: isSet(object.accountNumber) ? long_1.default.fromString(object.accountNumber) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.TxBody = {
    ...
    fromJSON(object) {
        return {
            ...
            timeoutHeight: isSet(object.timeoutHeight) ? long_1.default.fromString(object.timeoutHeight) : long_1.default.UZERO,
...
exports.Fee = {
    ...
    fromJSON(object) {
        return {
            ...
            gasLimit: isSet(object.gasLimit) ? long_1.default.fromString(object.gasLimit) : long_1.default.UZERO,
