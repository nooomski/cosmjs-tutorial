...
exports.ClientState = {
    ...
    fromJSON(object) {
        return {
            ...
            frozenSequence: isSet(object.frozenSequence) ? long_1.default.fromString(object.frozenSequence) : long_1.default.UZERO,
...
exports.ConsensusState = {
    ...
    fromJSON(object) {
        return {
            ...
            timestamp: isSet(object.timestamp) ? long_1.default.fromString(object.timestamp) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.NextSequenceRecvData = {
    ...
    fromJSON(object) {
        return {
            path: isSet(object.path) ? bytesFromBase64(object.path) : new Uint8Array(),
            nextSeqRecv: isSet(object.nextSeqRecv) ? long_1.default.fromString(object.nextSeqRecv) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
