...
exports.Fraction = {
    ...
    fromJSON(object) {
        return {
            numerator: isSet(object.numerator) ? long_1.default.fromString(object.numerator) : long_1.default.UZERO,
            denominator: isSet(object.denominator) ? long_1.default.fromString(object.denominator) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
