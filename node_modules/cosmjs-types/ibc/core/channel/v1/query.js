...
exports.QueryChannelConsensusStateRequest = {
    ...
    fromJSON(object) {
        return {
            portId: isSet(object.portId) ? String(object.portId) : "",
            channelId: isSet(object.channelId) ? String(object.channelId) : "",
            revisionNumber: isSet(object.revisionNumber) ? long_1.default.fromString(object.revisionNumber) : long_1.default.UZERO,
            revisionHeight: isSet(object.revisionHeight) ? long_1.default.fromString(object.revisionHeight) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.QueryPacketCommitmentRequest = {
    ...
    fromJSON(object) {
        return {
            portId: isSet(object.portId) ? String(object.portId) : "",
            channelId: isSet(object.channelId) ? String(object.channelId) : "",
            sequence: isSet(object.sequence) ? long_1.default.fromString(object.sequence) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromJSON(object) {
        return {
            ...
            packetCommitmentSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.packetCommitmentSequences)
                ? object.packetCommitmentSequences.map((e) => long_1.default.fromString(e))
                : [],
        };
    },
    toJSON(message) {
...
exports.QueryUnreceivedPacketsResponse = {
    ...
    fromJSON(object) {
        return {
            sequences: Array.isArray(object === null || object === void 0 ? void 0 : object.sequences) ? object.sequences.map((e) => long_1.default.fromString(e)) : [],
            height: isSet(object.height) ? client_1.Height.fromJSON(object.height) : undefined,
        };
    },
    toJSON(message) {
    ...
    fromJSON(object) {
        return {
            ...
            packetAckSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.packetAckSequences)
                ? object.packetAckSequences.map((e) => long_1.default.fromString(e))
                : [],
        };
    },
    toJSON(message) {
...
function createBaseQueryNextSequenceReceiveResponse() {
    return { nextSequenceReceive: long_1.default.UZERO, proof: new Uint8Array(), proofHeight: undefined };
}
