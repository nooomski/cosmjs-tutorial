...
function createBaseConnectionEnd() {
    return { clientId: "", versions: [], state: 0, counterparty: undefined, delayPeriod: long_1.default.UZERO };
}
exports.ConnectionEnd = {
    ...
    fromJSON(object) {
        return {
            ...
            delayPeriod: isSet(object.delayPeriod) ? long_1.default.fromString(object.delayPeriod) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
...
function createBaseIdentifiedConnection() {
    return { id: "", clientId: "", versions: [], state: 0, counterparty: undefined, delayPeriod: long_1.default.UZERO };
}
