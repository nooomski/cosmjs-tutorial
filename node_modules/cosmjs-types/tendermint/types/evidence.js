...
exports.DuplicateVoteEvidence = {
    ...
    fromJSON(object) {
        return {
            ...
            validatorPower: isSet(object.validatorPower) ? long_1.default.fromString(object.validatorPower) : long_1.default.ZERO,
    ...
    fromJSON(object) {
        return {
            conflictingBlock: isSet(object.conflictingBlock)
                ...
                : undefined,
            commonHeight: isSet(object.commonHeight) ? long_1.default.fromString(object.commonHeight) : long_1.default.ZERO,
