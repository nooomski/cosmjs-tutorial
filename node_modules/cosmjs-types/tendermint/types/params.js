...
exports.BlockParams = {
    ...
    fromJSON(object) {
        return {
            ...
            timeIotaMs: isSet(object.timeIotaMs) ? long_1.default.fromString(object.timeIotaMs) : long_1.default.ZERO,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.EvidenceParams = {
    ...
    fromJSON(object) {
        return {
            maxAgeNumBlocks: isSet(object.maxAgeNumBlocks) ? long_1.default.fromString(object.maxAgeNumBlocks) : long_1.default.ZERO,
...
exports.HashedParams = {
    ...
    fromJSON(object) {
        return {
            blockMaxBytes: isSet(object.blockMaxBytes) ? long_1.default.fromString(object.blockMaxBytes) : long_1.default.ZERO,
            blockMaxGas: isSet(object.blockMaxGas) ? long_1.default.fromString(object.blockMaxGas) : long_1.default.ZERO,
        };
    },
    toJSON(message) {
        const obj = {};
