...
exports.RequestInfo = {
    ...
    fromJSON(object) {
        return {
            ...
            blockVersion: isSet(object.blockVersion) ? long_1.default.fromString(object.blockVersion) : long_1.default.UZERO,
            p2pVersion: isSet(object.p2pVersion) ? long_1.default.fromString(object.p2pVersion) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.RequestInitChain = {
    ...
    fromJSON(object) {
        return {
            ...
            initialHeight: isSet(object.initialHeight) ? long_1.default.fromString(object.initialHeight) : long_1.default.ZERO,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.RequestLoadSnapshotChunk = {
    ...
    fromJSON(object) {
        return {
            height: isSet(object.height) ? long_1.default.fromString(object.height) : long_1.default.UZERO,
...
exports.ResponseInfo = {
    ...
    fromJSON(object) {
        return {
            ...
            version: isSet(object.version) ? String(object.version) : "",
            appVersion: isSet(object.appVersion) ? long_1.default.fromString(object.appVersion) : long_1.default.UZERO,
            lastBlockHeight: isSet(object.lastBlockHeight) ? long_1.default.fromString(object.lastBlockHeight) : long_1.default.ZERO,
...
exports.ResponseCheckTx = {
    ...
    fromJSON(object) {
        return {
            ...
            log: isSet(object.log) ? String(object.log) : "",
            info: isSet(object.info) ? String(object.info) : "",
            gasWanted: isSet(object.gas_wanted) ? long_1.default.fromString(object.gas_wanted) : long_1.default.ZERO,
            gasUsed: isSet(object.gas_used) ? long_1.default.fromString(object.gas_used) : long_1.default.ZERO,
            events: Array.isArray(object === null || object === void 0 ? void 0 : object.events) ? object.events.map((e) => exports.Event.fromJSON(e)) : [],
            codespace: isSet(object.codespace) ? String(object.codespace) : "",
        };
    },
...
exports.ResponseCommit = {
    ...
    fromJSON(object) {
        return {
            data: isSet(object.data) ? bytesFromBase64(object.data) : new Uint8Array(),
            retainHeight: isSet(object.retainHeight) ? long_1.default.fromString(object.retainHeight) : long_1.default.ZERO,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.BlockParams = {
    ...
    fromJSON(object) {
        return {
            maxBytes: isSet(object.maxBytes) ? long_1.default.fromString(object.maxBytes) : long_1.default.ZERO,
...
exports.Evidence = {
    ...
    fromJSON(object) {
        return {
            ...
            height: isSet(object.height) ? long_1.default.fromString(object.height) : long_1.default.ZERO,
            time: isSet(object.time) ? fromJsonTimestamp(object.time) : undefined,
            totalVotingPower: isSet(object.totalVotingPower) ? long_1.default.fromString(object.totalVotingPower) : long_1.default.ZERO,
        };
    },
    toJSON(message) {
        const obj = {};
