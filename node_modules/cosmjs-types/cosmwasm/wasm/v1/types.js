    ...
    fromJSON(object) {
        return {
            ...
            instantiateDefaultPermission: isSet(object.instantiateDefaultPermission)
                ...
                : 0,
            maxWasmCodeSize: isSet(object.maxWasmCodeSize) ? long_1.default.fromString(object.maxWasmCodeSize) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.ContractInfo = {
    ...
    fromJSON(object) {
        return {
            codeId: isSet(object.codeId) ? long_1.default.fromString(object.codeId) : long_1.default.UZERO,
            creator: isSet(object.creator) ? String(object.creator) : "",
...
exports.AbsoluteTxPosition = {
    ...
    fromJSON(object) {
        return {
            blockHeight: isSet(object.blockHeight) ? long_1.default.fromString(object.blockHeight) : long_1.default.UZERO,
            txIndex: isSet(object.txIndex) ? long_1.default.fromString(object.txIndex) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
